...
public interface VideoService {
	...
	public Video selectVideoImgById(Integer video_id);// 通过id查看视频
	...
	Video getVideoById(int id);//根据视频id查询视频信息
	 ...
	 * @return
	 */
	//List<Video> selectLimit(@Param("vi")List<Video> vi, @Param("begin")Integer begin);
